...
- 2026-03-07 [Fixed] BUG-012 Recent Files: auto-detected annotations.json no longer added to recent files list; only files explicitly opened or saved by the user are recorded (REQ-027)
